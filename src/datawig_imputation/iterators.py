...
class ImputerIter(mx.io.DataIter):
    ...
    Constructs an MxNet Iterator for a datawig_imputation.imputation.Imputer given a table in csv format

    :param data_columns: list of featurizers, see datawig_imputation.column_featurizer
...
class ImputerIterDf(ImputerIter):
    ...
    Constructs an MxNet Iterator for a datawig_imputation.imputation.Imputer given a pandas dataframe
